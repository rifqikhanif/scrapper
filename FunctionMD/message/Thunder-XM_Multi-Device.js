...
${left}${opener}
${left}${left}🪧 *Bot Name:* 
${left}${left}  *BabyBot-Md*
${left}${left}${taipye} *Baileys-md (beta)*
${left}${left}🩸 *Version:* *2.1*
${left}${left}${runtz}    
  ...
  case 'menu2':{  
   ...
   let buttonss = [{
      index: 1, 
       ...
       url: 'https://www.instagram.com/call_me_killl'
       }
       }, 
       {
       index: 1, 
       urlButton: {
       displayText: 'NEED HELP WITH BUGS?', 
       url: 'https://wa.me/62895421438653'
       }
       }, 
       {
     index: 2, 
